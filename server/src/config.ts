...
export const config = {
  ...
  maxFileSize: parseInt(process.env.MAX_FILE_SIZE || String(5 * 1024 * 1024 * 1024), 10),
  ...
  paths: {
    ...
    signed: path.resolve(__dirname, '..', 'signed'),
    manifests: path.resolve(__dirname, '..', 'manifests'),
    install: path.resolve(__dirname, '..', 'public', 'install'),
